...
//    //设置APPID/AK/SK
//    public static final String APP_ID = "22885289";
//    public static final String API_KEY = "2vhb7vjICx3TbGMb9ylWfo0H";
//    public static final String SECRET_KEY = "bdo68pgW0pG9RRiGrYToMIAwo0PhAALC";
...
////        client.setSocketTimeoutInMillis(60000);
////        // 调用接口
////        String path = "C:\\Users\\hudi9\\Desktop\\work\\jpg\\答案.jpg";
////        JSONObject res = client.basicGeneral(path, new HashMap<String, String>());
////        System.out.println(res.toString(2));
////
//////        // 读取pdf文件
//////        String path = "C:\\Users\\hudi9\\Desktop\\work\\健康管理师\\1.pdf";
//////        pdfParse(path);
////
////    }
//
