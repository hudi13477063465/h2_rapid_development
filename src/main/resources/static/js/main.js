	  ...
	  //触发事件  
	   ...
	   $(document).on('click','a',function(){  
	    ...
	    $(document).on('click','.layui-tab-title li',function(){  
			...
			$('.layui-nav-item,.layui-nav-child dd').removeClass("layui-this");
			$(".layui-nav-item a[lay-id="+ a +"]").parent().addClass("layui-this");
		});  

		// lyw 删除tab
		$(document).on('click','.layui-tab-close',function(){  
			var a = $('.layui-tab-title li.layui-this').attr("lay-id");
			$('.layui-nav-item,.layui-nav-child dd').removeClass("layui-this");
			$(".layui-nav-item a[lay-id="+ a +"]").parent().addClass("layui-this");
		});  
